...
uint4 get_03ADC()
{
  uint16 three = getADCNum(3);// 565 679  350-420V  942
  if(three <250)
  {
    return 1;
  }
...
//P0.7/ADC4/线盘温度 10K 5V   0正常 1表示超温 2表示开路   240c
uint4 get_07ADC()
{
